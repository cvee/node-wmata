...
/**
 * Creates an instance of WebServiceClient.
 *
 * @constructor
 * @this {Client}
 * @param {String} apiKey
 */
var WebServiceClient = function(apiKey)
{
...
Util.inherits(WebServiceClient, LPWebServiceClient);
 ...
 */
WebServiceClient.prototype.apiKey = function()
{
    return this._apiKey;
}
 ...
 */
WebServiceClient.prototype.busPositions = function(routeId, includeVariations, latitude, longitude, radius, callback)
{
    var parameters = {
        routeId: routeId,
 ...
 * @param {Function} callback The callback function.
 */
WebServiceClient.prototype.busPrediction = function(stopId, callback)
{
 ...
 * @param {Function} callback The callback function.
 */
WebServiceClient.prototype.busRouteDetails = function(routeId, date, callback)
{
    var parameters = {routeId: routeId, date: date};
 ...
 * @param {Function} callback The callback function.
 */
WebServiceClient.prototype.busRoutes = function(callback)
{
 ...
 * @param {Function} callback The callback function.
 */
WebServiceClient.prototype.busRouteSchedule = function(routeId, date, includeVariations, callback)
{
    var parameters = {
        routeId: routeId,
        date: date,
 ...
 * @param {Function} callback The callback function.
 */
WebServiceClient.prototype.busStops = function(latitude, longitude, radius, callback)
{
    var parameters = {
        lat: latitude,
        lon: longitude,
 ...
 * @param {Function} callback The callback function.
 */
WebServiceClient.prototype.busStopSchedule = function(stopId, date, includeVariations, callback)
{
    var parameters = {
        stopId: stopId,
        date: date,
 ...
 * @param {Function} callback The callback function.
 */
WebServiceClient.prototype.elevatorIncidents = function(stationCode, callback)
{
 ...
 * @param {Function} callback The callback function.
 */
WebServiceClient.prototype.railIncidents = function(callback)
{
 ...
 * @param {Function} callback The callback function.
 */
WebServiceClient.prototype.railLines = function(callback)
{
 ...
 * @param {Function} callback The callback function.
 */
WebServiceClient.prototype.railPaths = function(fromStationCode, toStationCode, callback)
{
 ...
 * @param {Function} callback The callback function.
 */
WebServiceClient.prototype.railStationEntrances = function(latitude, longitude, radius, callback)
{
    var parameters = {
        lat: latitude,
        lon: longitude,
 ...
 * @param {Function} callback The callback function.
 */
WebServiceClient.prototype.railStationInfo = function(stationCode, callback)
{
    var parameters = {StationCode: stationCode};
 ...
 * @param {Function} callback The callback function.
 */
WebServiceClient.prototype.railStationPrediction = function(stationCodes, callback)
{
 ...
 * @param {Function} callback The callback function.
 */
WebServiceClient.prototype.railStations = function(lineCode, callback)
{
 ...
 */
WebServiceClient.prototype._createRequestURL = function(module, resource, format, parameters)
{
